...
for row_index, row in irrgationData.iterrows():
    ...
    # print(date_object)
    timeValue = datetime(date_object.year,
                         date_object.month,
                         date_object.day,
                         tzinfo=TZ()).isoformat()
    # print(timeValue)
...
# ----- A. Set up file path
greenhouseFilePath = "C:/Users/sarah/Dropbox/IoT4Ag/CEAOD/Greenhouse_climate/GH_Cucumber/AutonomousGreenhouseChallenge2018/AiCU/Greenhouse_climate.csv"  # noqa: E501
...
# ----- A. Set up file path
resourceCalcFilePath = "C:/Users/sarah/Dropbox/IoT4Ag/CEAOD/ResourceCalculations/GH_Cucumber/AutonomousGreenhouseChallenge2018/AiCU/ResourceCalculations.csv"  # noqa: E501
