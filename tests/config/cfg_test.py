...
def test_check_sensors():
    test_dict1 = {"name": "test_farm", "sensors": [{"value": 25}]} #Does not contain "type" field
...
def test_add_sensors():
    ...
    sensors_list = []
    test_dict = {"name": "env1", "sensors": [{"type": "temp", "value": 10},
                {"type": "pH", "value": 5.8}, {"type": "EC", "value": 0.8}]}
